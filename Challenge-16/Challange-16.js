...
var name = 'Erik';
for(var i = 0, len = name.length; i < name.length; i++){
    console.len(name.charAt(i) + ' é a ' + (i + 1 ) + '° letra do meu nome.');
}
/*
...
var fullNmae = 'erik-gomes-sensitivo';
var newfullNmae = fullNmae.split('-').map(function(){
    return name.charAt(0).toUpperCase() + name.slice(1);
}).join('');
console.log(fullNmae);
console.log(newfullNmae);
/*
...
*/
console.log( '\nMeus amigos:' );
var amigos = ['Henrique', 'Paulo', 'Pedro', 'Guilherme', 'Matheus'];
