(function (){
    ...
    */
    ...
    console.log (text.replace(/Manuel Marques de Sousa/, 'Erik Gomes'));
    ...
    */
    ...
    console.log(text.replace(/[D-Hh-d]/g, 0));
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/g, function(regex, frase){
    ...
    */
    ...
    console.log(texte.replace(regexDate, replaceDate));
});