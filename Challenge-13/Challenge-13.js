(function(){
   ...
   var sudesde = ['Espírito Santo', 'Minas Gerais', 'Rio de Janeiro', 'São Paulo']
    ...
    */
   var nordeste = ['Maranhão', 'Piauí', 'Alagoas', 'Bahia', 'Creará', 'Paraíba', 'Pernambuco', 'Rio Grande do Norte', 'Sergipe'];
    ...
    */
    ...
    console.log(soma ? 'Ceará está incluído!': 'Ceará não foi incluído :(')

    /*
    Percorra o array `newBrasil` e crie um novo array que some 1 no ID de cada
    oo9   e array, e adicione a frase abaixo na propriedade `estado`:
